...
# url_file_name=r"C:\Users\admin\Desktop\DSA\project\indices\url_list.json"
# id=get_url_id(url_file_name)
# print(f"\nid={id}\n")   
# data=["www.x.com","www.milo.com","www.canid.com"]
# dump_url_data(data,url_file_name)
